...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='./data/imagenet', type=str,
                        help='dataset path')
    parser.add_argument('--class_filter', default='', type=str,
                        help='class filter')
...
def main(args):
    ...
    full_dataset = datasets.ImageFolder(root=args.data_path, transform=transform_train)

    akiec_index = full_dataset.class_to_idx[args.class_filter]
    filtered_samples = [(path, label) for path, label in full_dataset.samples if label == akiec_index]
