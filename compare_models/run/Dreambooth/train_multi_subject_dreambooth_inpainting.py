...
def parse_args():
    ...
    parser.add_argument("--metadata-file", required=True, type=str,  help="meta data path")
    parser.add_argument(
        "--output_dir",
        type=str,
...
class DreamBoothDataset(Dataset):
    def __init__(
        ...
        self.train_data = [item for item in self.metadata if item['dataset_split'] == 'train_val']
        self.test_data = [item for item in self.metadata if item['dataset_split'] == 'test']
    ...
    def __getitem__(self, index):
        ...
        mask_path = meta["seg_path"]
        mask = Image.open(mask_path)
        mask = self.set_image(mask, switch)
